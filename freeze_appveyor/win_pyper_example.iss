...
#define MyAppName "pyper example"
#define MyzmAppName "pyper example"
...
AppId={{P607CB56-B737-440D-ABBC-CWC310CE7C70}
AppName={#MyzmAppName}
...
[Files]
Source: "C:\projects\pyins\dist\pyper_example\pyper example.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\projects\pyper example\dist\pyper example\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
